const data = [{
    ...
    answers: ["Baddha Konasana", "Vasisthasana", "Sivasana"]
    ...
    answers: ["Ustrasana", "Urdhva Mukha Svsnssana", "Virabhadrasana One"]
    ...
    answers: ["Ustrasana", "Marjaryasana", "Virabhadrasana One"]
    ...
    answers: ["Ustrasana", "Bitilasana", "Virabhadrasana One"]
    ...
    answers: ["Ustrasana", "Bitilasana", "Utkatasana"]
    ...
    answers: ["Balasana", "Bitilasana", "Utkatasana"]
    ...
    answers: ["Balasana", "Alanasana", "Bakasana"]
    ...
    answers: ["Balasana", "Alanasana", "Ardha Pincha Mayurasana"]
    ...
    answers: ["Adho Mukha Svanasana", "Alanasana", "Ardha Pincha Mayurasana"]
    ...
    answers: ["Ardha Chandrasana", "Vasisthasana", "Garudasana"]
}, {
    "id": 17,
    ...
    answers: ["Baddha Konasana", "Utthita Hasta Padangusthasana", "Setu Bandha Sarvangasana"]
    ...
    answers: ["Utthita Parsvakonasana", "Alanasana", "Ardha Pincha Mayurasana"]
    ...
    answers: ["Utthita Parsvakonasana", "Pincha Mayurasana", "Ardha Pincha Mayurasana"]
    ...
    answers: ["Utthita Parsvakonasana", "Pincha Mayurasana", "Uttanasana"]
    ...
    answers: ["Ardha Chandrasana", "Vasisthasana", "Trikonasana"]
}, {
    "id": 22,
    ...
    answers: ["Adho Mukha Vrksasana", "Pincha Mayurasana", "Uttanasana"]
    ...
    answers: ["Baddha Konasana", "Anjaneyasana", "Setu Bandha Sarvangasana"]
    ...
    answers: ["Adho Mukha Vrksasana", "Supta Kapotasana", "Uttanasana"]
    ...
    answers: ["Adho Mukha Vrksasana", "Eka Pada Rajakapotasana", "Uttanasana"]
    ...
    answers: ["Adho Mukha Vrksasana", "Eka Pada Rajakapotasana", "Phalakasana"]
    ...
    answers: ["Halasana", "Eka Pada Rajakapotasana", "Phalakasana"]
    ...
    answers: ["Halasana", "Eka Pada Rajakapotasana", "Parsvottanasana"]
    ...
    answers: ["Baddha Konasana", "Anjaneyasana", "Parsva Virabhadrasana"]
    ...
    answers: ["Paschimottanasana", "Eka Pada Rajakapotasana", "Parsvottanasana"]
    ...
    answers: ["Padmasana", "Vasisthasana", "Trikonasana"]
}, {
    "id": 32,
    ...
    answers: ["Paschimottanasana", "Ardha Matsyendrasana", "Parsvottanasana"]
    ...
    answers: ["Baddha Konasana", "Salamba Sarvangasana", "Parsva Virabhadrasana"]
    ...
    answers: ["Camatkarasana", "Vasisthasana", "Dhanurasana"]
}, {
    "id": 35,
    "sanskrit_name": "Salamba Bhujangasana",
    "english_name": "Sphinx",
    "img_url": "https://www.dropbox.com/s/cl8teqpf9yingwm/sphinx.svg?raw=1",
    answers: ["Salamba Bhujangasana", "Salamba Sarvangasana", "Parsva Virabhadrasana"]
    ...
    answers: ["Salamba Bhujangasana", "Hanumanasana", "Parsva Virabhadrasana"]
    ...
    answers: ["Salamba Bhujangasana", "Ashta Chandrasana", "Parsva Virabhadrasana"]
    ...
    answers: ["Salamba Bhujangasana", "Ashta Chandrasana", "Upavistha Konasana"]
    ...
    answers: ["Vrksasana", "Ashta Chandrasana", "Upavistha Konasana"]
    ...
    answers: ["Camatkarasana", "Vasisthasana", "Trikonasana"]
    ...
    answers: ["Vrksasana", "Urdhva Mukha Svsnssana", "Upavistha Konasana"]
    ...
    answers: ["Vrksasana", "Urdhva Mukha Svsnssana", "Virabhadrasana One"]
    ...
    answers: ["Virabhadrasana Two", "Urdhva Mukha Svsnssana", "Virabhadrasana One"]
    ...
    answers: ["Padmasana", "Virabhadrasana", "Trikonasana"]
}, {
    "id": 47,
    "sanskrit_name": "Urdhva Dhanurasana",
    "english_name": "Wheel",
    "img_url": "https://www.dropbox.com/s/kpa1bewuut3lm5q/wheel.svg?raw=1",
    answers: ["Padmasana", "Virabhadrasana Three", "Urdhva Dhanurasana"]
}, {
    "id": 48,
